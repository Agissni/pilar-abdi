    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow-sm border-0">
                ...
                <div class="card-footer bg-light border-0 pt-4">
                    <a href="{{ url('/pendaftaran') }}?paket=reguler" class="btn btn-outline-primary w-100 py-3">Pilih Paket Dasar</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow border-primary position-relative" style="transform: scale(1.03);">
                ...
                <div class="card-footer bg-light border-0 pt-4">
                    <a href="{{ url('/pendaftaran') }}?paket=intensif" class="btn btn-primary w-100 py-3">Pilih Paket Intensif</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow-sm border-0">
                ...
                <div class="card-footer bg-light border-0 pt-4">
                    <a href="{{ url('/pendaftaran') }}?paket=tahunan" class="btn btn-outline-primary w-100 py-3">Pilih Paket Pro</a>
                </div>
            </div>
        </div>
